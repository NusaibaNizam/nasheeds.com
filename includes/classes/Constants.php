<?php
	...
	class Constants
	{
		...
		public static $emailExists="This Emails is already in use";
		public static $userNameLengthError="Your User Name should be between 25 to 3 characters";
		public static $userNameExists="This User Name is taken";
		...
		public static $logInError="User Name or Password Incorrect";
	}
?>